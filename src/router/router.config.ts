...
export const accessRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        redirect: '/admin/projectManage/agent',
        meta: {
          title: 'projectManage',
          keepAlive: true,
          icon: 'jiaosequanxian',
        ...
        children: [
          {
            path: '/admin/projectManage/agent',
            name: 'agent',
          ...
          {
            path: '/admin/projectManage/device',
            name: 'device',
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: '/admin/confManage/timeSpan',
            name: 'timeSpan',
            component: () => import('/@/views/timeSpan/index.vue'),
            meta: {
              title: 'timeSpan',
              keepAlive: true,
              icon: 'caidan',
