  ...
  <div class="roleRights">
    ...
    <div class="rightsCont">
      <a-tabs v-model:activeKey="activeKey">
        <a-tab-pane key="1" :tab="$t('rightsConf')">
        ...
        <a-tab-pane key="2" :tab="$t('userList')" force-render>
          <div class="roleRightsTab">
            <a-menu v-model:selectedKeys="selectedUsers">
              <a-menu-item v-for="user in roleUserList" :key="user.id">
                <div class="userRoleItem">
                  ...
                  <div class="userOp">
                    <a-select v-model:value="selectedKeys" style="width:150px; float: right;" :placeholder="$t('changeRole')" v-if="selectedUsers[0] === user.id">
                      <a-select-option v-for="item in enums.roleType" :value="item">{{ $t('roleType'+item) }}</a-select-option>
                    </a-select>
                  </div>
                </div>
              </a-menu-item>
